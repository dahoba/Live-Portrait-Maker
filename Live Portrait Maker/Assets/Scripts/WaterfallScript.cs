...
public class WaterfallScript : MonoBehaviour
{
    ...
    [Range(0.0f, 2f)] public float Liquid = 1.0f;
    [Range(-2.0f, 4f)] public float Speed = 1.0f;
    [Range(-2f, 2f)] public float EValue = -0.65f;
    ...
    void Awake()
    {
        ...
        __MainTex2 = Resources.Load("WaterfallScriptTexture") as Texture2D;
